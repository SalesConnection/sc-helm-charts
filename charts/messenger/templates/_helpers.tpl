...
ConfigMap name
*/}}
{{- define "messenger.configMapName" -}}
{{- default (printf "%s-%s" .Release.Name "config") .Values.configMap.name }}
{{- end }}

{{/*
ConfigMap supervisor name
*/}}
{{- define "messenger.configMapSupervisordName" -}}
{{- default (printf "%s-%s" .Release.Name "supervisord-config") .Values.supervisor.name }}
{{- end }}
